# -*- coding: utf-8 -*-
"""
Created on Thu Nov 13 17:28:17 2025
...
if __name__ == "__main__":
    variants ="D:\\research\\m6Acancer_prediction\\m6A_mutation\\paper_wirting\\data\\Input_data\\all_m6A_syn_mutations.bed"
    outputDir = "D:\\research\\m6Acancer_prediction\\m6A_mutation\\paper_wirting\\data\\Input_data\\GC_content\\"

    # reads in the human GRCh38 genome in fasta format
    record_dict = SeqIO.to_dict(SeqIO.parse("D:\\Data\\GRCh38.primary_assembly.genome.fa", "fasta"))
    ...
    data_merge.to_csv(output_file, index=None)
