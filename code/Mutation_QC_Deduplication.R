...
fwrite(mutation_set, "/home/disk1/zhangteng/Reasearch/big_data/Missense_Synonymous_mutation_set.tsv", sep = "\t")
...
fwrite(missense_mutation_set, "/home/disk1/zhangteng/Reasearch/big_data/Missense_mutation_set.tsv", sep = "\t")
